/* ----------------------------------
jQuery Timelinr 0.9.7v2
tested with jQuery v1.6+
Updated to add a let settings to prevent errors on browser developer console
  ...
  $(function(){
    ...
    if ($(settings.datesDiv).length > 0 && $(settings.issuesDiv).length > 0) {
      ...
      if(settings.autoPlay == 'true') {
        autoPlayTimer(settings)
      }
    }
  });
}

function autoPlayTimer(settings){
  // set default timer
